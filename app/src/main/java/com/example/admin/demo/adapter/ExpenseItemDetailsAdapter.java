...
public class ExpenseItemDetailsAdapter extends RecyclerView.Adapter<ExpenseItemDetailsAdapter.MyViewHolder> {
    private DecimalFormat df;
    private ArrayList<ExpenseDetailsListPojo> invoiceItemDetailsArrayList;
    private Context context;

    public ExpenseItemDetailsAdapter(ArrayList<ExpenseDetailsListPojo> invoiceItemDetailsArrayList,
                                     Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_expense_item_details, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tv_item_discount.setText(invoiceItemDetails.getTotalitemAmount());
