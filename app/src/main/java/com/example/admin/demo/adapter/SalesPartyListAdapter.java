...
public class SalesPartyListAdapter extends RecyclerView.Adapter<SalesPartyListAdapter.MyViewHolder> {
    ...
    public SalesPartyListAdapter(Context context, ArrayList<PartyDetailsPojo> partyDetailsPojoList) {
